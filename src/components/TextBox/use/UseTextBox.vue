...
<template>
  <VCard class="pa-4">
    <template #title><h2>TextBox</h2></template>
    <template #subtitle>
      <VRow>
    ...
    <template #text>
      <VRow>
        ...
        <VCol cols="12">
          <InputBox v-model:value="defaultValue" />
        </VCol>
        <!-- 2.로딩바 -->
        <VCol cols="12">
        ...
        <VCol cols="12">
          <TextInputBox v-model:value="textValue" />
        </VCol>
        <!-- 4.숫자 -->
        <VCol cols="12">
          <h3>NumberInputBox</h3>
        </VCol>
        <VCol cols="12">
          <NumberInputBox v-model:value="numberValue" :fixed="2" />
        </VCol>
        <!-- 5.이메일 -->
        <VCol cols="12">
          <h3>EmailInputBox</h3>
