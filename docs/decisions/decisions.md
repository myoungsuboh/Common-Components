...
| ADR-2026-08-24-header-menu-by-right-click | 컬럼 헤더 메뉴의 진입점을 ∨ 버튼에서 헤더 우클릭으로 옮기고, 우클릭을 선점하던 컬럼 선택기를 끔 | dev (execute-dev) | 2026-08-24 06:09 | 승인됨 | [2026-08-24-header-menu-by-right-click.md](2026-08-24-header-menu-by-right-click.md) |
| ADR-2026-08-24-tristate-sort-and-original-order-restore | 헤더 좌클릭을 오름·내림·해제 3단계로 바꾸고, 해제 시 기준 필드로 재정렬해 원래 순서를 복원하며 단일 정렬을 기본으로 둠 | dev (execute-dev) | 2026-08-24 06:45 | 승인됨 | [2026-08-24-tristate-sort-and-original-order-restore.md](2026-08-24-tristate-sort-and-original-order-restore.md) |
